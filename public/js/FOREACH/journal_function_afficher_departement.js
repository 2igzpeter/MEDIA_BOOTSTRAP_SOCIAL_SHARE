...
function afficherTous(tableauDeFilms) {
    tableauDeFilms.forEach(function (news) {
        ...
        var txt_into_a_4 = document.createTextNode('5');
         ...
         function myFunction_snackbar_departement() {


            $(function(){

              $('#p_economie').text("Catégorie: Département");
              $('#p_txt_catégorie').text("Catégorie: ");
              $('#p_catégorie').text( "Département");

            })
    }myFunction_snackbar_departement()
    ...
    $.get("http://localhost:8080/filterDepartement", function (response, error) {
       
        console.log(error);
        console.log('VOICI LE CONTENUE DE LA BDD FRANCE ALL ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------FRANCE-------------------------------BDD ----------------------------BDD --------------BDD -BDD BDD ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------BDD -------------FRANCE---------------------------------------------------BDD -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------FRANCE------------------------------------------------------------------------------------------------------------------------------------------------------------------FRANCE------------------------------------------------------------------------------------------------------------------------------------------------------------------FRANCE-----------------------------BDD -------------------------------FRANCE------------------------------------------------------------------------------------------------------------------------------------------------------------------FRANCE-----------------------------------------------------------------------------------------')
        console.log(response);
     afficherTous(response);
