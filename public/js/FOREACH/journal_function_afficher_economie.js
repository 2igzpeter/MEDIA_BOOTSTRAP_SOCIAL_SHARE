...
function afficherPlusieursFilms(tableauDeFilms) {
    ...
    $('#p_catégorie').css('color','bleu' );

     function myFunction_snackbar_economie() {
...
$(function(){
  ...
  $('#p_economie').text("Catégorie: Economie");
    $('#p_txt_catégorie').text("Catégorie: ");

    $('#p_catégorie').text("Economie")
...
myFunction_snackbar_economie();


    
    $.get("http://localhost:8080/filtereconomie", function (response, error) {
